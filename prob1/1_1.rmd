...
(In Korean: 쉽게 Real line에서의 interval 집합으로 이루어진 class의 smallest $\sigma$-field가 Borel $\sigma$-field 라고 생각하자. (실수에서의 Entire set이기 때문에 $\Omega$가 아니라 $\mathbb{R}$이라고 생각하면 쉽게 이해될 것이다.)
