...
<br>
   ...
   * 증명 : 
   ...
   4. Let $a_{n}:=\int f_{n}d\mu$, $a_{ {n_{kj}} }:=\int f_{ {n_{kj}} }d\mu$, and $a:=\int f\mbox{ }d\mu$. From above results, $a_n\rightarrow a$ i.e., $\int f_{n}\mbox{ }d\mu\rightarrow \int f\mbox{ }d\mu$.
